package br.com.fiapbook.user.model.messages;
...
public class UserMessages {
  ...
  public static final String USER_PASSWORD_MUST_HAVE_MIN_EIGHT_CHAR_AND_MAX_TWENTY_CHAR = "Password must have min eight and max twenty characters.";
}
